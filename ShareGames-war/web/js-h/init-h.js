(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: 'css-h/style-h.css', containers: 1140, grid: { gutters: 40 } },
			'wide':		{ range: '-1680', href: 'css-h/style-wide-h.css', containers: 960 },
			'normal':	{ range: '-1080', href: 'css-h/style-normal-h.css', containers: '95%', viewport: { scalable: false } },
			'narrow':	{ range: '-840', href: 'css-h/style-narrow-h.css', grid: { gutters: 30 } },
			'mobile':	{ range: '-736', href: 'css-h/style-mobile-h.css', containers: '95%!', grid: { collapse: true, gutters: 20 } }
		}
	});
