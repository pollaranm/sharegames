...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Evento.updateAll", query = "UPDATE Evento e SET e.eventoPK.idimpianto = :idimpianto, e.eventoPK.idcampo = :idcampo, e.eventoPK.data = :data, e.eventoPK.ora = :ora, e.completo= :completo, e.pagato = :pagato, e.giocatoripagato = :giocatoripagato, e.sport = :sport WHERE e.eventoPK.idevento = :idevento"),
